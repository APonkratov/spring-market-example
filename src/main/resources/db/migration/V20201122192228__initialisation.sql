...
insert into price (timestamp, product_id, price)
values (to_timestamp('2020-01-01 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), 1, 1000),
       (to_timestamp('2020-01-02 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), 1, 1200);
